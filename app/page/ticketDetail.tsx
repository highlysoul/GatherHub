      ...
      >
        ...
        <View style={styles.ticketCard}>
          ...
          <View style={styles.detailsSection}>
            <View style={styles.detailRow}>
              <View style={styles.detailItem}>
                ...
                <Text style={styles.detailValue}>{ticket?.event_date}</Text>
              </View>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailItem}>
                ...
                <Text style={styles.detailValue}>${ticket?.price || 0}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.codeSection}>
            ...
            <Text style={styles.codeValue}>{ticket?.ticket_code}</Text>
