...
export default function QrisPayment() {
  ...
  const handleSimulatePay = async () => {
    ...
    try {
      ...
      if (ticketError) {
        Alert.alert("Ticket Error", ticketError.message);
      ...
      await supabase
        .from("events")
        .update({
          participants_count: (eventData?.participants_count || 0) + 1,
        })
        .eq("id", Number(params.eventId));
  ...
  const handleViewTicket = () => {
    router.replace("/page/viewTickets");
  };
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successAmount}>${price}</Text>
          ...
          >
            ...
            >
              ...
              <Text style={styles.viewTicketText}>View My Ticket</Text>
            </LinearGradient>
          </TouchableOpacity>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successSubtitle}>
            The QR code expired or payment was cancelled.
          </Text>
          ...
          >
            <LinearGradient
              ...
              style={styles.viewTicketBtn}
            >
              <Text style={styles.viewTicketText}>Try Again</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.qrCard}>
          <View style={styles.qrHeader}>
            ...
            <Text style={styles.merchantName}>GatherHub</Text>
          </View>
          ...
          <View style={styles.qrContainer}>
            <View style={styles.qrGrid}>
              {Array.from({
                ...
                const filled = (i * 7 + 3) % 5 === 0 || (i * 3) % 7 === 0;
          ...
          <Text style={styles.qrInstruction}>Scan with your e-wallet</Text>
        ...
        {status === "processing" ? (
          ...
          >
            ...
            >
              ...
              <Text style={styles.simulateText}>I have paid</Text>
            </LinearGradient>
          </TouchableOpacity>
        )}
